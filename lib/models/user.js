...
const UserSchema = new Schema({
  ...
  lastLoggedIn: { type: Date, default: Date.now, select: false },
...
const allUserPropsForAuth = '+apiKey +super +lastLoggedIn +updatedAt +pwdLastChangedAt +akLastChangedAt +numLogins'; // -password

export { allUserPropsForAuth };
